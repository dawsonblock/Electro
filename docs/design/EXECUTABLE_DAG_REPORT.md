...
1. "What model are you running on and what version of ELECTRO?"
...
### `crates/electro-agent/src/blueprint.rs` (+513 lines)
...
### `crates/electro-agent/src/runtime.rs` (+216 lines)
...
### `crates/electro-core/src/types/config.rs` (+7 lines)

- `parallel_phases: bool` added to `AgentConfig`
- `#[serde(default)]` — defaults to `false`
- Added to `Default` impl

### `crates/electro-agent/src/lib.rs` (+2 lines)
