...
The allowlist persists at `~/.electro/discord_allowlist.toml`.
...
Discord has a 2000-character message limit. ELECTRO automatically splits long responses at natural boundaries (newlines, then spaces).
