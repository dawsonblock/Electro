...
## Context
OpenClaw's security is opt-in (sandbox is optional, WebSocket has cross-origin issues). ZeroClaw is better (deny-by-default allowlists) but ELECTRO handles user credentials via chat, making security even more critical.
