...
impl BrowserPool {
    ...
    pub async fn new(max_size: usize) -> Result<Self, ElectroError> {
        ...
        ensure_browser_runtime_policy("browser pool")?;
    ...
    pub async fn get_page(&self, slot: usize) -> Result<Page, ElectroError> {
        ...
        let params = CreateTargetParams::builder()
            ...
            .build()
            .map_err(|e| ElectroError::Tool(format!("BrowserPool page params: {e}")))?;

        let page = browser
            .new_page(params)
            .await
            .map_err(|e| ElectroError::Tool(format!("BrowserPool page create: {e}")))?;
    ...
    pub async fn release(&self, slot: usize) -> Result<(), ElectroError> {
...

        {
            ...
            let new_ctx_id = browser
                .create_browser_context(CreateBrowserContextParams::builder().build())
                .await
                .map_err(|e| ElectroError::Tool(format!("BrowserPool release: {e}")))?;
