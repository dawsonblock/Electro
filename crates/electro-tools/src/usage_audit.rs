...
impl UsageAuditTool {
    ...
    async fn handle_summary(&self, ctx: &ToolContext) -> Result<ToolOutput, ElectroError> {
...
mod tests {
    ...
    impl UsageStore for MockUsageStore {
        ...
        async fn is_usage_display_enabled(&self, _chat_id: &str) -> Result<bool, ElectroError> {
