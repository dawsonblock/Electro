...
impl TaskGraph {
    ...
    pub fn new(goal: &str, subtasks: Vec<SubTask>) -> Result<Self, ElectroError> {
    ...
    pub fn mark_running(&mut self, id: &str) -> Result<(), ElectroError> {
    ...
    pub fn topological_order(&self) -> Result<Vec<String>, ElectroError> {
    ...
    fn detect_cycle(&self) -> Result<(), ElectroError> {
        // Build in-degree map
...
fn topological_sort(tasks: &HashMap<String, SubTask>) -> Result<Vec<String>, ElectroError> {
    let mut in_degree: HashMap<&str, usize> = HashMap::new();
    let mut adj: HashMap<&str, Vec<&str>> = HashMap::new();
...
pub fn parse_decomposition(llm_response: &str, goal: &str) -> Result<Vec<SubTask>, ElectroError> {
