...
impl SubAgent {
    ...
    pub fn start(&mut self) -> Result<(), ElectroError> {
    ...
    /// Mark as completed.
    pub fn complete(&mut self) -> Result<(), ElectroError> {
    ...
    /// Mark as failed.
    pub fn fail(&mut self) -> Result<(), ElectroError> {
        if self.status != SubAgentStatus::Running {
            return Err(ElectroError::Internal(format!(
    ...
    /// Mark as timed out.
    pub fn time_out(&mut self) -> Result<(), ElectroError> {
        if self.status != SubAgentStatus::Running {
            return Err(ElectroError::Internal(format!(
...
impl DelegationManager {
    ...
    pub fn register_spawn(&self) -> Result<usize, ElectroError> {
    ...
    ) -> Result<Vec<SubAgent>, ElectroError> {
