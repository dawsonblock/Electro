...
//!
//! Run: `cargo test -p electro-distill --test bench_eigentune -- --nocapture`

use chrono::Utc;
use std::collections::HashMap;
use electro_distill::collector::EigenTunePairData;
use electro_distill::config::EigenTuneConfig;
use electro_distill::judge::behavior::{behavior_observation, signal_to_observation};
use electro_distill::judge::embedding::{cheap_equivalence_check, cosine_similarity, is_equivalent};
use electro_distill::stats::beta::{beta_mean, beta_update, beta_variance};
use electro_distill::stats::cusum::Cusum;
use electro_distill::stats::entropy::normalized_entropy;
use electro_distill::stats::sprt::{Sprt, SprtDecision};
use electro_distill::stats::wilson::{wilson_interval, wilson_lower};
use electro_distill::store::EigenTuneStore;
use electro_distill::types::{EigenTier, QualitySignal, TierState};
use electro_distill::EigenTuneEngine;
...
async fn test_10_domain_classification() {
    use electro_distill::collector::EigenTuneCollector;
