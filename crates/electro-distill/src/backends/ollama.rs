...
pub async fn list_models() -> Result<Vec<OllamaModel>, electro_core::types::error::ElectroError> {
    let client = reqwest::Client::new();
    let resp = client
        .get(format!("{}/api/tags", OLLAMA_BASE))
        .send()
        .await
        .map_err(|e| electro_core::types::error::ElectroError::Tool(format!("Ollama list: {}", e)))?;

    if !resp.status().is_success() {
        let err = resp.text().await.unwrap_or_default();
        return Err(electro_core::types::error::ElectroError::Tool(format!(
            "Ollama list error: {}",
            err
        )));
    }
    ...
    let list: OllamaModelList = resp.json().await.map_err(|e| {
        electro_core::types::error::ElectroError::Tool(format!("Ollama parse: {}", e))
    })?;
...
pub async fn create_model(
    ...
    let client = reqwest::Client::builder()
        ...
        .build()
        .map_err(|e| electro_core::types::error::ElectroError::Tool(format!("HTTP client: {}", e)))?;
    ...
    let resp = client
        ...
        .await
        .map_err(|e| {
            electro_core::types::error::ElectroError::Tool(format!("Ollama create: {}", e))
        })?;
...
/// Delete a model.
pub async fn delete_model(name: &str) -> Result<(), electro_core::types::error::ElectroError> {
    let client = reqwest::Client::new();
    ...
    client
        ...
        .await
        .map_err(|e| {
            electro_core::types::error::ElectroError::Tool(format!("Ollama delete: {}", e))
        })?;
...
pub async fn embed(
    text: &str,
    model: &str,
) -> Result<Vec<f64>, electro_core::types::error::ElectroError> {
    let client = reqwest::Client::builder()
    ...
    let resp = client
        ...
        .await
        .map_err(|e| {
            electro_core::types::error::ElectroError::Tool(format!("Ollama embed: {}", e))
        })?;
    ...
    let parsed: OllamaEmbedResponse = resp
        .json()
        .await
        .map_err(|e| electro_core::types::error::ElectroError::Tool(format!("Parse embed: {}", e)))?;

    parsed
        .embeddings
        .into_iter()
        .next()
        .ok_or_else(|| electro_core::types::error::ElectroError::Tool("Empty embedding".into()))
}
...
pub async fn ensure_embedding_model(
    ...
    if !has_model {
        ...
        let client = reqwest::Client::builder()
            ...
            .build()
            .map_err(|e| {
                electro_core::types::error::ElectroError::Tool(format!("HTTP client: {}", e))
            })?;
        ...
        let resp = client
            ...
            .await
            .map_err(|e| {
                electro_core::types::error::ElectroError::Tool(format!("Ollama pull: {}", e))
            })?;
