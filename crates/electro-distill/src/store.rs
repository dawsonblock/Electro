...
impl EigenTuneStore {
    ...
    pub async fn new(database_url: &str) -> Result<Self, ElectroError> {
        let pool = SqlitePoolOptions::new()
            ...
            .await
            .map_err(|e| ElectroError::Memory(format!("EigenTune: failed to connect: {e}")))?;
    ...
    async fn init_tables(&self) -> Result<(), ElectroError> {
        ...
        .execute(&self.pool)
        .await
        .map_err(|e| ElectroError::Memory(format!("EigenTune: create pairs table: {e}")))?;
        ...
        .execute(&self.pool)
        .await
        .map_err(|e| ElectroError::Memory(format!("EigenTune: create pairs index: {e}")))?;
        ...
        .execute(&self.pool)
        .await
        .map_err(|e| ElectroError::Memory(format!("EigenTune: create conv index: {e}")))?;
        ...
        .execute(&self.pool)
        .await
        .map_err(|e| ElectroError::Memory(format!("EigenTune: create runs table: {e}")))?;
        ...
        .execute(&self.pool)
        .await
        .map_err(|e| ElectroError::Memory(format!("EigenTune: create tiers table: {e}")))?;
        ...
        for tier in &["simple", "standard", "complex"] {
            ...
            .execute(&self.pool)
            .await
            .map_err(|e| ElectroError::Memory(format!("EigenTune: seed tier {tier}: {e}")))?;
        }
        ...
        .execute(&self.pool)
        .await
        .map_err(|e| ElectroError::Memory(format!("EigenTune: create observations table: {e}")))?;

        sqlx::query("CREATE INDEX IF NOT EXISTS idx_et_obs_tier ON eigentune_observations(tier)")
            .execute(&self.pool)
            .await
            .map_err(|e| ElectroError::Memory(format!("EigenTune: create obs index: {e}")))?;
    ...
    pub async fn save_pair(&self, pair: &TrainingPair) -> Result<(), ElectroError> {
        ...
        .execute(&self.pool)
        .await
        .map_err(|e| ElectroError::Memory(format!("EigenTune: save pair: {e}")))?;

        Ok(())
    }

    /// Fetch a single training pair by id.
    pub async fn get_pair(&self, id: &str) -> Result<Option<TrainingPair>, ElectroError> {
        let row = sqlx::query("SELECT * FROM eigentune_pairs WHERE id = ?1")
            .bind(id)
            .fetch_optional(&self.pool)
            .await
            .map_err(|e| ElectroError::Memory(format!("EigenTune: get pair: {e}")))?;
    ...
    pub async fn update_quality(
        ...
        .execute(&self.pool)
        .await
        .map_err(|e| ElectroError::Memory(format!("EigenTune: update quality: {e}")))?;
    ...
    pub async fn update_signal(
        ...
        let column = match signal_field {
            ...
            other => {
                return Err(ElectroError::Memory(format!(
        ...
        sqlx::query(&sql)
            ...
            .execute(&self.pool)
            .await
            .map_err(|e| ElectroError::Memory(format!("EigenTune: update signal: {e}")))?;
    ...
    pub async fn get_pairs_for_tier(
        ...
        .fetch_all(&self.pool)
        .await
        .map_err(|e| ElectroError::Memory(format!("EigenTune: get pairs for tier: {e}")))?;
    ...
    pub async fn get_recent_pair(
        ...
        .fetch_optional(&self.pool)
        .await
        .map_err(|e| ElectroError::Memory(format!("EigenTune: get recent pair: {e}")))?;
    ...
    pub async fn count_pairs(&self, tier: &str) -> Result<i64, ElectroError> {
        let row = sqlx::query("SELECT COUNT(*) as cnt FROM eigentune_pairs WHERE complexity = ?1")
            ...
            .fetch_one(&self.pool)
            .await
            .map_err(|e| ElectroError::Memory(format!("EigenTune: count pairs: {e}")))?;
    ...
    pub async fn count_high_quality_pairs(
        ...
        .fetch_one(&self.pool)
        .await
        .map_err(|e| ElectroError::Memory(format!("EigenTune: count high quality: {e}")))?;

        Ok(row.get::<i64, _>("cnt"))
    }

    /// Get domain category distribution for a tier.
    pub async fn get_category_counts(&self, tier: &str) -> Result<Vec<(String, i64)>, ElectroError> {
        let rows = sqlx::query(
            r#"
        ...
        .fetch_all(&self.pool)
        .await
        .map_err(|e| ElectroError::Memory(format!("EigenTune: category counts: {e}")))?;
    ...
    pub async fn get_all_category_counts(&self) -> Result<Vec<(String, i64)>, ElectroError> {
        let rows = sqlx::query(
            r#"
            SELECT COALESCE(domain_category, 'uncategorized') as cat, COUNT(*) as cnt
            FROM eigentune_pairs
        ...
        .fetch_all(&self.pool)
        .await
        .map_err(|e| ElectroError::Memory(format!("EigenTune: all category counts: {e}")))?;
    ...
    pub async fn total_pairs(&self) -> Result<i64, ElectroError> {
        let row = sqlx::query("SELECT COUNT(*) as cnt FROM eigentune_pairs")
            .fetch_one(&self.pool)
            .await
            .map_err(|e| ElectroError::Memory(format!("EigenTune: total pairs: {e}")))?;
    ...
    pub async fn total_high_quality(&self, threshold: f64) -> Result<i64, ElectroError> {
        ...
        .await
        .map_err(|e| {
            ElectroError::Memory(format!("EigenTune: total high quality: {e}"))
        })?;
    ...
    pub async fn save_run(&self, run: &TrainingRun) -> Result<(), ElectroError> {
        ...
        .execute(&self.pool)
        .await
        .map_err(|e| ElectroError::Memory(format!("EigenTune: save run: {e}")))?;
    ...
    pub async fn update_run(&self, run: &TrainingRun) -> Result<(), ElectroError> {
        ...
        .execute(&self.pool)
        .await
        .map_err(|e| ElectroError::Memory(format!("EigenTune: update run: {e}")))?;
    ...
    pub async fn get_run(&self, id: &str) -> Result<Option<TrainingRun>, ElectroError> {
        let row = sqlx::query("SELECT * FROM eigentune_runs WHERE id = ?1")
            ...
            .fetch_optional(&self.pool)
            .await
            .map_err(|e| ElectroError::Memory(format!("EigenTune: get run: {e}")))?;
    ...
    pub async fn get_tier(&self, tier: &str) -> Result<TierRecord, ElectroError> {
        let row = sqlx::query("SELECT * FROM eigentune_tiers WHERE tier = ?1")
            ...
            .fetch_optional(&self.pool)
            .await
            .map_err(|e| ElectroError::Memory(format!("EigenTune: get tier: {e}")))?;
        ...
        match row {
            ...
            None => {
                ...
                .execute(&self.pool)
                .await
                .map_err(|e| ElectroError::Memory(format!("EigenTune: init tier: {e}")))?;
    ...
    pub async fn update_tier(&self, record: &TierRecord) -> Result<(), ElectroError> {
        ...
        .execute(&self.pool)
        .await
        .map_err(|e| ElectroError::Memory(format!("EigenTune: update tier: {e}")))?;
    ...
    pub async fn get_all_tiers(&self) -> Result<Vec<TierRecord>, ElectroError> {
        let rows = sqlx::query("SELECT * FROM eigentune_tiers ORDER BY tier")
            .fetch_all(&self.pool)
            .await
            .map_err(|e| ElectroError::Memory(format!("EigenTune: get all tiers: {e}")))?;
    ...
    pub async fn save_observation(&self, obs: &Observation) -> Result<(), ElectroError> {
        ...
        .execute(&self.pool)
        .await
        .map_err(|e| ElectroError::Memory(format!("EigenTune: save observation: {e}")))?;
