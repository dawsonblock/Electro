//! Test utilities and mocks for ELECTRO.
//!
...
/// Fluent builder for `ElectroConfig` in tests.
...
impl TestConfigBuilder {
    ...
    pub fn build(self) -> ElectroConfig {
        self.config
    }
}
...
pub fn make_session() -> SessionContext {
    let workspace = std::env::temp_dir().join(format!("electro-test-{}", uuid::Uuid::new_v4()));
