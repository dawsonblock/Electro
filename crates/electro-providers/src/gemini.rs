...
impl GeminiProvider {
    ...
    /// Convert ELECTRO messages to Gemini format.
    ...
    /// Convert Gemini response to ELECTRO format.
...
impl Provider for GeminiProvider {
    ...
    async fn complete(
        ...
        let response = self
            ...
            .send()
            .await
            .map_err(|e| ElectroError::Provider(format!("Gemini HTTP error: {e}")))?;

        let status = response.status();
        let body = response
            .text()
            .await
            .map_err(|e| ElectroError::Provider(format!("Gemini response read error: {e}")))?;
    ...
    async fn health_check(&self) -> Result<bool, ElectroError> {
        ...
        let response = self
            ...
            .send()
            .await
            .map_err(|e| ElectroError::Provider(format!("Gemini health check error: {e}")))?;
    ...
    async fn list_models(&self) -> Result<Vec<String>, ElectroError> {
        ...
        let response = self
            ...
            .send()
            .await
            .map_err(|e| ElectroError::Provider(format!("Gemini list models error: {e}")))?;

        let body: serde_json::Value = response
            .json()
            .await
            .map_err(|e| ElectroError::Provider(format!("Gemini parse error: {e}")))?;
