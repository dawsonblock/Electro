...
impl Observable for MetricsCollector {
    ...
    async fn record_metric(
        ...
        let mut map = self
            .gauges
            .write()
            .map_err(|e| ElectroError::Internal(format!("gauges lock poisoned: {e}")))?;
    ...
    async fn increment_counter(
        ...
        let map = self
            .counters
            .read()
            .map_err(|e| ElectroError::Internal(format!("counters lock poisoned: {e}")))?;
    ...
    async fn observe_histogram(
        ...
        let mut map = self
            .histograms
            .write()
            .map_err(|e| ElectroError::Internal(format!("histograms lock poisoned: {e}")))?;
