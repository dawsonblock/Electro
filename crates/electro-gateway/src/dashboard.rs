...
<body>
  ...
  <p class="footer">ELECTRO Agent Runtime &mdash; Dashboard is read-only</p>
</body>
</html>"##,
...
mod tests {
    ...
    fn test_state() -> Arc<AppState> {
        ...
        let tools: Vec<Arc<dyn electro_core::Tool>> = Vec::new();
    ...
    async fn dashboard_page_returns_200_with_html() {
        ...
        assert!(html.contains("ELECTRO Dashboard"));
