//! ELECTRO Channels crate
//!
//! Provides messaging channel implementations (CLI, Telegram, etc.) that
//! conform to the `Channel` and `FileTransfer` traits defined in `electro-core`.
...
pub fn create_channel(
    ...
    match name {
        ...
        "discord" => Err(ElectroError::Config(
