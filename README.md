...
| Layer | Protection |
|-------|-----------|
| **Access control** | Deny-by-default. First user bootstrap requires `TEMM1E_ALLOW_FIRST_USER_BOOTSTRAP=1`. Numeric IDs only. |
| **Network isolation**| Browser and web_fetch are restricted to public web destinations or explicit `TEMM1E_PUBLIC_WEB_ALLOWLIST`. |
