# ELECTRO Tem's Mind v2.0 — Tool-Heavy A/B Benchmark Report
...
- **Fresh state**: Both `~/.electro/memory.db` and per-version `memory.db` cleaned before run
...
*Generated by ELECTRO Tem's Mind v2.0 benchmark harness*
